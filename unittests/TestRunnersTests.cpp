...
TEST(SimpleTestRunner, runTestUsingLibC) {
  auto ModuleWithTests = parseIR("@.str = private unnamed_addr constant [6 x i8] c\"ababa\\00\", align 1 \n"
  ...
  auto ModuleWithTestees = parseIR("define i32 @count_letters(i8* %s, i8 signext %c) {\n"
                                   "entry:\n"
