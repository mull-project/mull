...
createModuleFromBitcode(const char *fixtureName,
  ...
  return MullModule::validModule(std::move(llvmModule.get()),
                                 "fake_hash",
                                 fixtureFullPath);
}
...
MullModule TestModuleFactory::createModule(const char *fixtureName,
                                           const char *moduleIdentifier) {
  ...
  return MullModule::validModule(std::move(module), "fake_hash", "fake_path");
}
...
MullModule TestModuleFactory::create_SimpleTest_NegateCondition_Tester_Module() {
  const char *fixture = "simple_test/mutation_operators/negate_condition/tester.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::create_SimpleTest_NegateCondition_Testee_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_RemoveVoidFunction_Tester_Module() {
  const char *fixture = "simple_test/mutation_operators/remove_void_function/tester.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::create_SimpleTest_RemoveVoidFunction_Testee_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_ANDORReplacement_Module() {
  const char *fixture = "simple_test/mutation_operators/and_or_replacement/test_and_or_operators.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::create_SimpleTest_ANDORReplacement_CPPContent_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_ScalarValue_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_ReplaceAssignment_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_ReplaceCall_Module() {
...
MullModule TestModuleFactory::create_SimpleTest_CountLettersTest_Module() {
  const char *fixture = "simple_test/count_letters/test_count_letters.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::create_SimpleTest_CountLetters_Module() {
  return createModuleFromBitcode("simple_test/count_letters/count_letters.bc", "count_letters");
}

#pragma mark - Google Test

MullModule TestModuleFactory::create_GoogleTest_Tester_Module() {
  return createModuleFromBitcode("google_test/google_test/Test.bc",
                                 "google_test_tester");
}

MullModule TestModuleFactory::create_GoogleTest_Testee_Module() {
...
MullModule TestModuleFactory::APInt_9a3c2a89c9f30b6c2ab9a1afce2b65d6_213_0_17_negate_mutation_operatorModule() {
...
MullModule TestModuleFactory::APFloat_019fc57b8bd190d33389137abbe7145e_214_2_7_negate_mutation_operatorModule() {
  const char *fixture = "APFloat_019fc57b8bd190d33389137abbe7145e_214_2_7_negate_mutation_operator.ll";
  return createModule(fixture, fixture);
}

MullModule TestModuleFactory::APFloat_019fc57b8bd190d33389137abbe7145e_5_1_3_negate_mutation_operatorModule() {
  const char *fixture = "APFloat_019fc57b8bd190d33389137abbe7145e_5_1_3_negate_mutation_operator.ll";
  return createModule(fixture, fixture);
}

MullModule TestModuleFactory::create_CustomTest_Distance_Distance_Module() {
  const char *fixture = "custom_test/distance/distance.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::createCustomTest_Distance_Main_Module() {
  const char *fixture = "custom_test/distance/main.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::createCustomTest_Distance_Test_Module() {
  const char *fixture = "custom_test/distance/test.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::createCustomTest_DylibsAndObjects_Test_Module() {
  const char *fixture = "custom_test/dylibs_and_objects/test.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::createCustomTest_DylibsAndObjects_Main_Module() {
  const char *fixture = "custom_test/dylibs_and_objects/main.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::createCustomTest_DylibsAndObjects_Distance_Module() {
  const char *fixture = "custom_test/dylibs_and_objects/distance.bc";
  return createModuleFromBitcode(fixture, fixture);
}

MullModule TestModuleFactory::create_CustomTest_OpenSSL_bio_enc_test_Module() {
...
MullModule TestModuleFactory::rustModule() {
