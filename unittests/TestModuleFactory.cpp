...
std::unique_ptr<Module> TestModuleFactory::create_SimpleTest_MathMul_module() {
...
std::unique_ptr<Module> TestModuleFactory::create_SimpleTest_ANDORReplacement_CPPContent_Module() {
