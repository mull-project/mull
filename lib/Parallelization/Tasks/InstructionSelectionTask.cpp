...
InstructionSelectionTask::InstructionSelectionTask(const std::vector<InstructionFilter *> &filters)
    : filters(filters) {}

void InstructionSelectionTask::operator()(iterator begin, iterator end, Out &storage,
