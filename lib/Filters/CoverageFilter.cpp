...
loadCoverage(const MullConfig &configuration, Diagnostics &diagnostics,
...
CoverageFilter::CoverageFilter(const MullConfig &configuration, Diagnostics &diagnostics,
