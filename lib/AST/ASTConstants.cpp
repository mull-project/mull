...
std::vector<std::tuple<clang::BinaryOperator::Opcode, mull::MutatorKind,
    ...
    mull::BinaryMutations = {
      ...
      { clang::BO_ShlAssign,
        ...
        ">>=" },
      { clang::BO_ShrAssign,
        MutatorKind::CXX_RShiftAssignToLShiftAssign,
        clang::BO_ShlAssign,
        "<<=" },
    };

std::vector<std::tuple<clang::UnaryOperator::Opcode, mull::MutatorKind, std::string>>
    mull::UnaryMutations = { { clang::UO_LNot, MutatorKind::CXX_RemoveNegation, "" },
