...
mull_runner = r.Rlocation(f"_main/rust/mull-tools/mull-runner-{llvm_major_version}")
...
mull_instrument = r.Rlocation(f"mull/mull-instrument-{llvm_major_version}")
...
config.substitutions.append(("%mull_instrument", mull_instrument))
