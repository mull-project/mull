...
// CHECK-NEXT:{{.*}}/header.h:7:12: warning: // CHECK-NEXT:Survived: Replaced - with + [cxx_sub_to_add]
// CHECK-NEXT:  return a - b;
// CHECK-NEXT:           ^
// CHECK-NEXT:{{.*}}/main.c:21:16: warning: // CHECK-NEXT:Survived: Replaced - with + [cxx_sub_to_add]
// CHECK-NEXT:  return a + b - c; // mull-ignore: cxx_add_to_sub
// CHECK-NEXT:               ^
// CHECK-NEXT:{{.*}}/main.c:26:16: warning: // CHECK-NEXT:Survived: Replaced - with + [cxx_sub_to_add]
