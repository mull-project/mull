    ...
    for llvm_version in AVAILABLE_LLVM_VERSIONS:
        native.filegroup(
            ...
            srcs = [
                ...
                "//tests/unit/fixtures/mutators:%s_and_or/and_to_or_replacement_cpp/junk.cpp.bc" % llvm_version,
                "//tests/unit/fixtures/mutators:%s_and_or/or_to_and_replacement_cpp/junk.cpp.bc" % llvm_version,
